...
<p><b>Reports summarising one FEA</b> have a 'Communities overview' homepage (grey inset), which provides a list of communities (green frame in grey inset), a silhouette plot of communities (i), and a <a href="https://github.com/avigailtaylor/GeneFEAST/blob/main/graphical_grid_search.md">graphical grid search of community detection parameters</a> (ii). The Communities overview homepage has the following anchor links (black, solid arrows) into the ‘Full report’: 
<ul>
